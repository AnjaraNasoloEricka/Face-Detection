...
function Facecomparaison() {
  ...
  return (
    <>
        ...
        <img ref={idCardRef} src={require('./img/img.jpg')}  width="500" alt="ID card" height="auto" />
        </div>

        <div className="gallery">
        <img ref={selfieRef} src={require('./img/selfie.webp')} width="500"  alt="Selfie" height="auto" />
        </div>
    </>
  );
}

export default Facecomparaison;